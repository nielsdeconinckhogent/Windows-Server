...
.DESCRIPTION
  Dit script zal de netwerkadapter veranderen naar Intern. Intern zal bijgevolg het IP adres 192.168.100.20 toegewezen krijgen.
.NOTES
  Version:        1.0
...
function SetIPAndDns {
    ...
    New-NetIPAddress -InterfaceIndex $adapter.ifIndex -IPAddress 192.168.100.20 -PrefixLength 24 -DefaultGateway 192.168.100.10 -ErrorAction Stop
