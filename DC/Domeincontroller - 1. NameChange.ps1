...
.DESCRIPTION
  Dit script zal da naam van de server instellen op WIN-DC-ALFA
.NOTES
  Version:        1.0
...
function RenameComputer {
    Rename-Computer -NewName "WIN-DC-ALFA" -Restart
}

#-----------------------------------------------------------[Execution]------------------------------------------------------------

while($go -eq 1) {
Write-Host -BackgroundColor Black -ForegroundColor Cyan "Dit script zal de naam van $env:computername veranderen in WIN-DC-ALFA."
